...
def listing_companies (live=True, source='SSI'):
    """
...
def company_overview (symbol):
    ...
    df = df.rename(columns={
            'ticker': 'ma_co_phieu',
            'exchange': 'san_giao_dich',
            'industry': 'nganh_cong_nghiep',
            'companyType': 'loai_cong_ty',
            'noShareholders': 'so_co_dong',
            'foreignPercent': 'ty_le_co_dong_nuoc_ngoai',
            'outstandingShare': 'so_luong_co_phieu_luu_hanh',
            'issueShare': 'so_luong_co_phieu_phat_hanh',
            'establishedYear': 'nam_thanh_lap',
            'noEmployees': 'so_luong_nhan_vien',
            'stockRating': 'danh_gia_co_phieu',
            'deltaInWeek': 'bien_dong_trong_tuan',
            'deltaInMonth': 'bien_dong_trong_thang',
            'deltaInYear': 'bien_dong_trong_nam'
        })
    return df
...
def financial_ratio (symbol, report_range, is_all=False):
    ...
    name_mapping = {
        ...
        'quarter': 'Quy',
        'year': 'Nam',
        'priceToEarning': 'Gia_tri_Loi_nhuan_tren_Co_phieu_(P_E)',
        'priceToBook': 'Gia_tri_So_sach_tren_Co_phieu_(P_B)',
        'roe': 'Ty_suat_loi_nhuan_tren_Von_chu_so_huu_(ROE)',
        'roa': 'Ty_suat_loi_nhuan_tren_Tong_tai_san_(ROA)',
        'earningPerShare': 'Loi_nhuan_tren_moi_co_phieu_(EPS)',
        'bookValuePerShare': 'Gia_tri_So_sach_tren_moi_co_phieu',
        'interestMargin': 'Bien_lai_suat',
        'nonInterestOnToi': 'Thu_nhap_khong_tu_lai_suat_tren_Tong_thu_nhap',
        'badDebtPercentage': 'Ty_le_No_xau',
        'provisionOnBadDebt': 'Du_phong_cho_No_xau',
        'costOfFinancing': 'Chi_phi_tai_chinh',
        'equityOnTotalAsset': 'Von_chu_so_huu_tren_Tong_tai_san',
        'equityOnLoan': 'Von_chu_so_huu_tren_Khoan_vay',
        'costToIncome': 'Ty_le_Chi_phi_so_voi_Thu_nhap',
        'equityOnLiability': 'Von_chu_so_huu_tren_Nguon_von',
        'epsChange': 'Thay_doi_ve_Loi_nhuan_tren_Co_phieu',
        'assetOnEquity': 'Tai_san_tren_Von_chu_so_huu',
        'preProvisionOnToi': 'Loi_truoc_du_phong',
        'postTaxOnToi': 'Loi_sau_thue_tren_Tong_thu_nhap',
        'loanOnEarnAsset': 'Khoan_vay_tren_Tai_san_co_thu_nhap',
        'loanOnAsset': 'Khoan_vay_tren_Tong_tai_san',
        'loanOnDeposit': 'Khoan_vay_tren_Tien_gui',
        'depositOnEarnAsset': 'Tien_gui_tren_Tai_san_co_thu_nhap',
        'badDebtOnAsset': 'No_xau_tren_Tong_tai_san',
        'liquidityOnLiability': 'Tinh_thanh_khoan_tren_Nguon_von',
        'payableOnEquity': 'No_phai_tra_tren_Von_chu_so_huu',
        'cancelDebt': 'Huy_no',
        'bookValuePerShareChange': 'Thay_doi_gia_tri_So_sach_tren_moi_co_phieu',
        'creditGrowth': 'Tang_truong_tin_dung',
        'valueBeforeEbitda': 'Gia_tri_Trong_truoc_EBITDA',
        'daysReceivable': 'So_ngay_Cho_thu',
        'daysInventory': 'So_ngay_Hang_ton_kho',
        'daysPayable': 'So_ngay_Cho_tra',
        'ebitOnInterest': 'EBIT_Tren_Lai_suat',
        'currentPayment': 'Thanh_toan_hien_tai',
        'quickPayment': 'Thanh_toan_nhanh',
        'ebitdaOnStock': 'EBITDA_Tren_Tong_von',
        'grossProfitMargin': 'Marginal_Loi_nhuan_gross',
        'operatingProfitMargin': 'Marginal_Loi_nhuan_hoat_dong',
        'postTaxMargin': 'Marginal_Sau_thue',
        'debtOnEquity': 'No_tren_Von_chu_so_huu',
        'debtOnAsset': 'No_tren_Tong_tai_san',
        'debtOnEbitda': 'No_tren_EBITDA',
        'shortOnLongDebt': 'No_ngan_han_tren_No_dai_han',
        'capitalBalance': 'Can_doi_von',
        'cashOnEquity': 'Tien_mat_tren_Von_chu_so_huu',
        'cashOnCapitalize': 'Tien_mat_tren_Boi_cap',
        'cashCirculation': 'Luu_thong_tien_mat',
        'revenueOnWorkCapital': 'Doanh_thu_tren_von_lam_viec',
        'capexOnFixedAsset': 'Chi_phi_dau_tu_cap_moi_tren_tai_san_co_dinh',
        'revenueOnAsset': 'Doanh_thu_tren_Tai_san',
        'postTaxOnPreTax': 'Lai_sau_thue_tren_Lai_truoc_thue',
        'ebitOnRevenue': 'EBIT_tren_Doanh_thu',
        'preTaxOnEbit': 'Lai_truoc_thue_tren_EBIT',
        'ebitdaOnStockChange': 'EBITDA_tren_Thay_doi_tong_von'
    }
